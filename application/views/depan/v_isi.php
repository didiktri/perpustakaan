...
<head>
  ...
  <title>HOME | Perpustakaan Digital ASSA</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="#">SIPUS DIGI</a></h1>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          <li><a class="scrollto" href="<?php echo base_url() . 'welcome/login'; ?>">Login Admin</a></li>
        </ul>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Aplikasi Perpustakaan Digital SMK Assa'idiyah Kudus</h1>
          <h2>Penunjang Program Pojok Baca di SMK Assa'idiyah Kudus</h2>
          <div><a href="#about" class="btn-get-started scrollto">Login Anggota</a></div>
        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="<?php echo base_url();?>assets/template/assets/img/perpus.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>Ds. Megawon Rt 06/01 Kec. Jati Kab. Kudus</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              ...
              <h3>Email Us</h3>
              <p>didikharmoko4565@gmail.com</p>
            </div>
          </div>
    ...
    <div class="footer-top">
      <div class="container">
            ...
            <p>
              ...
              <strong>Telp/Fax:</strong> (0291) 4247125<br>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Didik Tri Harmoko, S.Kom</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url();?>assets/template/assets/vendor/purecounter/purecounter_vanilla.js"></script>
